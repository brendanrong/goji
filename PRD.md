...
- Wispr Flow is paid and routes voice to a cloud server. For work use that's a data question we don't need to have.
...
- If v1 holds up for Brendan, package it and distribute to the rest of my team.
...
## Distribution to my team (later, after v1 proves out)
